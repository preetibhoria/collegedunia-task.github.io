...
function loadColleges(){
    ...
    for( var i = newLoad; i < loadCollege; i++){
    ...
    var intersectionObserver = new IntersectionObserver(function(entries) {
        ...
        console.log('Total college: '+collegesObj.colleges.length);
        console.log('loadCollege: '+loadCollege);
        console.log('newLoad: '+newLoad);

        if(loadCollege <=  collegesObj.colleges.length){
            loadColleges();
        }
    });
